...
EOF
    ...
    cat >>"$file" <<EOF
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name:
              <a class="string" href="https://github.com/mjwhitta/${name,,}" target="_parent">"$name"</a>,<br>
              &nbsp;&nbsp;&nbsp;&nbsp;},<br>
EOF
...
cat >>"$file" <<EOF
          ...
          <footer>
              <h1>
                <br>E:&nbsp;mj[@]whitta[.]dev | GitHub:&nbsp;<a class="link" href="https://github.com/mjwhitta" target="_parent">mjwhitta</a><br>
                <a class="link" href="https://www.credential.net/8d5c7efa-5a47-42aa-9917-f35e00f78750" target="_parent">CRTP (expired)</a>
                |
                <a class="link" href="https://www.offensive-security.com/ctp-osce" target="_parent">OSCE</a>
                |
                <a class="link" href="https://www.offensive-security.com/courses/pen-200" target="_parent">OSCP</a>
                |
                <a class="link" href="https://www.offensive-security.com/courses/pen-210" target="_parent">OSWP</a>
                |
                <a class="link" href="https://www.cisco.com/c/en/us/training-events/training-certifications/certifications/associate/ccna.html" target="_parent">CCNA (expired)</a>
              </h1>
          </footer>
        </div>
      </div>
