...
EOF
    ...
    cat >>"$file" <<EOF
              ...
              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name:
              <a class="string" href="https://github.com/mjwhitta/$repo">"$name"</a>,<br>
              &nbsp;&nbsp;&nbsp;&nbsp;},<br>
EOF
...
cat >>"$file" <<EOF
          ...
          <footer>
              <h1>
                <br>E:&nbsp;mj[@]whitta[.]dev | GitHub:&nbsp;<a class="link" href="https://github.com/mjwhitta">mjwhitta</a> | <a class="link" href="https://drive.google.com/file/d/0B-9ZqIg-lbVxYmVrVmtzTzdLWEE/view?usp=drive_link&resourcekey=0-u5TzpzvxWiar9NHCstKR7Q">Resume</a><br>
